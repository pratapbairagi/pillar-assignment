...
const SocialMediaLinks = () => {
    return (
        <div className="container-fluid py-2 socialMediaLinks">

            <div className="row d-flex justify-content-center">
                <div className="col col-12 col-sm-12 col-md-10 col-lg-8 col-xl-6 d-flex flex-wrap gap-2 justify-content-center">
                    <span>
